...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\mangalsutar3.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Glimmering Cascade Mangalsutra</h1>
      
      <div class="price">
        <span class="current-price">₹20,152</span>
      </div>
      
      <p class="product__description">
      The Glimmering Cascade Mangalsutra is a vision of elegance with its flowing, curved pendant set in white and yellow gold. Embellished with sparkling diamonds, the pendant’s delicate design adds a refined touch to traditional wear. This piece represents a cascade of blessings and prosperity, ideal for someone who values both grace and strength. The dual tones allow it to complement a wide range of outfits, from festive sarees to modern dresses, making it a versatile and treasured piece.
