...
<?php include 'header.php'; ?>
      <div class="hero-image">
        <img src="images/menhero.webp" alt="ringcover">
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull1.php" class="product-item-photo">
          <img src="images\menbracelet1.avif" alt="Balladry Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
            <a href="mensfull1.php" class="product-item-link">
            Ocean Breeze Beaded Bracelet
            </a>
          </strong>
          <div class="price-box">
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull2.php" class="product-item-photo">
          <img src="images\menbracelet2.jpeg" alt="Infinite Mesh Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
    <input type="hidden" name="product_name" value=" Silver Mesh Bracelet">
    <input type="hidden" name="product_price" value="16393">
    <input type="hidden" name="product_image" value="images\menbracelet2.jpeg">
    <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
              </form>
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull3.php" class="product-item-photo">
          <img src="images\menbracelet3.jpg" alt="Flairious Hera Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
            <a href="mensfull3.php" class="product-item-link">
            Bold Leather Strap Bracelet
            </a>
          </strong>
          <div class="price-box">
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
    <input type="hidden" name="product_name" value="Bold leather Strap Bracelet">
    <input type="hidden" name="product_price" value="20152">
    <input type="hidden" name="product_image" value="images\menbracelet3.jpg">
    <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
</form>
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull4.php" class="product-item-photo">
          <img src="images\menchain.jpeg" alt="Ekanta Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
    <input type="hidden" name="product_name" value="Silver Chain Necklace">
    <input type="hidden" name="product_price" value="14846">
    <input type="hidden" name="product_image" value="images\menchain.jpeg">
    <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
              </form>
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull5.php" class="product-item-photo">
          <img src="images\menpendant.jpg" alt="Sparkling Solitaire Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
            <a href="mensfull5.php" class="product-item-link">
            Gold Spearhead Pendant Necklace
            </a>
          </strong>
          <div class="price-box">
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
    <input type="hidden" name="product_name" value=" Gold Spearhead Pendant Necklace">
    <input type="hidden" name="product_price" value="22575">
    <input type="hidden" name="product_image" value="images\menpendant.jpg">
    <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
              </form>
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull6.php" class="product-item-photo">
          <img src="images\menpendnt2.jpg" alt="Elegant Eternity Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
            <a href="mensfull6.php" class="product-item-link">
           Cross crystal Pendant
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
    <input type="hidden" name="product_name" value="   Cross crystal Pendant">
    <input type="hidden" name="product_price" value="18999">
    <input type="hidden" name="product_image" value="images\menpendnt2.jpg">
    <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
              </form>
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull7.php" class="product-item-photo">
          <img src="images\menpendnt3.webp" alt="Twisted Love Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
    <input type="hidden" name="product_name" value=" Engraved Initial Pendant">
    <input type="hidden" name="product_price" value="21250">
    <input type="hidden" name="product_image" value="images\menpendnt3.webp">
    <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
              </form>
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull8.php" class="product-item-photo">
          <img src="images\menring1.jpg" alt="Blooming Flower Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
    <input type="hidden" name="product_name" value="  Geometric Diamond Rings">
    <input type="hidden" name="product_price" value="23750">
    <input type="hidden" name="product_image" value="images\menring1.jpg">
    <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
              </form>
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull9.php" class="product-item-photo">
          <img src="images\menring2.jpeg" alt="Vintage Charm Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
    <input type="hidden" name="product_name" value="   Golden Heart Diamond Ring">
    <input type="hidden" name="product_price" value="17999">
    <input type="hidden" name="product_image" value="images\menring2.jpeg">
    <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
              </form>
    ...
    <li class="item product product-item">
      <div class="product-item-info">
        <a href="mensfull10.php" class="product-item-photo">
          <img src="images\menring3.webp" alt="Radiant Starburst Diamond Ring" class="product-image-photo">
        </a>
        <div class="product-item-details">
          <strong class="product-item-name">
            <a href="mensfull10.php" class="product-item-link">
            Sapphire Royale Ring
            </a>
          </strong>
          <div class="price-box">
          ...
          <div class="product-item-actions">
          <form method="POST" action="wishlist.php" class="action towishlist">
            <input type="hidden" name="product_name" value=" Sapphire Royale Ring">
            <input type="hidden" name="product_price" value="24500">
            <input type="hidden" name="product_image" value="images\menring3.webp">
            <button type="submit" name="add_to_wishlist"><svg class="heart-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg></button>
              </form>
