...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\mangalsutar9.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Ornate Splendor Mangalsutra</h1>
      ...
      This mangalsutra is a statement piece, designed with a luxurious pendant that exudes grandeur. The Ornate Splendor Mangalsutra features intricate filigree work and diamond accents that bring an opulent touch. This piece is for brides who love bold, exquisite designs, as it is sure to turn heads. It’s a perfect representation of love and commitment, making it a meaningful and treasured piece that’s suitable for weddings and grand celebrations.
         </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="17999"> <!-- Ensure price is a number without commas -->
