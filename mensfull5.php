...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\menpendant.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Gold Spearhead Pendant Necklace</h1>
      ...
      A bold gold necklace with a sharp, spearhead-shaped pendant.      </p>
