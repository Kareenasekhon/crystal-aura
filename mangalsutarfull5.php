...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\mangalsutar5.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Ruby Swirl Mangalsutra</h1>
      
      <div class="price">
        <span class="current-price">₹22,575</span>
      </div>
      
      <p class="product__description">
      This unique mangalsutra combines the elegance of diamonds with the vibrancy of rubies, arranged in a mesmerizing swirl pattern. The Ruby Swirl Mangalsutra celebrates passion and commitment, ideal for a modern woman with a bold personality. The delicate chain is accented with gold highlights, giving the design a refined finish. Its striking pendant makes it a beautiful statement piece that pairs well with both ethnic and contemporary outfits, bringing a touch of luxury to any look.
        </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="22575"> <!-- Ensure price is a number without commas -->
