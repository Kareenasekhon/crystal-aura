...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\bangles1.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Mystic Mirage Bangles</h1>
      
      <div class="price">
        <span class="current-price">₹9,181</span>
      </div>
      
      <p class="product__description">
      This colorful stack of bangles, with hues ranging from pastel pinks and blues to shimmering golds, brings a sense of mystery and charm to any outfit. Embellished with small bead accents, this set captures the essence of a playful yet elegant look. Each bangle in the stack has its own unique design, making it a versatile choice for mixing and matching. Ideal for festive occasions or casual outings, these bangles add a pop of color to any attire. The lightweight design ensures comfort for extended wear, while the intricate detailing reflects skilled craftsmanship.
       </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="9181"> <!-- Ensure price is a number without commas -->
