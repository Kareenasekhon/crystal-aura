...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\bangles4.jpeg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Aqua Dream Bangles</h1>
      
      <div class="price">
        <span class="current-price">₹4,846</span>
      </div>
      
      <p class="product__description">
      The Aqua Dream Bangles are a refreshing addition to any collection, with their sea-inspired turquoise and silver design. Tiny stone accents in blue and green tones evoke the tranquility of ocean waves, creating a calming effect. These bangles are ideal for summer events or beach weddings, adding a light, airy feel to any outfit. The intricate patterning reflects the craftsmanship that goes into each piece, making them truly unique. They can be worn as a complete set or mixed with plain silver bangles for a more casual look.
      </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        <input type="hidden" name="product_name" value="Aqua Dream Bangles">
        <input type="hidden" name="product_price" value="4846"> <!-- Ensure price is a number without commas -->
