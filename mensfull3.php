...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\menbracelet3.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
             </div>
            </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Bold Leather Strap Bracelet</h1>
      ...
      A stylish, black leather bracelet with golden metal detailing.
      </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="20152"> <!-- Ensure price is a number without commas -->
  ...
  <script>
         document.addEventListener('click', function(event) {
            var accountMenu = document.querySelector('.menu.account');
            var accountPop = document.querySelector('.account-pop');
         ...
         document.querySelector('.login-menu').addEventListener('click', function(event) {
