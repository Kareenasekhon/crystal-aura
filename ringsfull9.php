...
<?php include 'header.php'; ?>
  ...
  <div class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images/ring9.png" alt="Silver Heart's Paradise Ring" width="533" height="533">
      </div>
    </div>
    <div class="product__info-wrapper">
      <h1 class="product__title">Vintage Charm Diamond Ring</h1>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        <input type="hidden" name="product_name" value="Vintage Charm Diamond Ring">
        <input type="hidden" name="product_price" value="17999"> <!-- Ensure price is a number without commas -->
        <input type="hidden" name="product_image" value="images/ring9.png">
