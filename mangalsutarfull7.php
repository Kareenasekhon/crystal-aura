...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\mangalsutar7.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Graceful Peony Mangalsutra</h1>
      
      <div class="price">
        <span class="current-price">₹21,250</span>
      </div>
      
      <p class="product__description">
      Adorned with a beautiful peony-inspired pendant, the Graceful Peony Mangalsutra represents love, beauty, and honor. The pendant’s rose-gold finish adds a soft, feminine touch, while the chain’s delicate black beads provide a traditional balance. Ideal for someone who appreciates fine details and soft elegance, this piece is perfect for women who want to showcase their delicate style while honoring traditional values. It is a beautiful expression of harmony, ideal for both special occasions and everyday elegance.
        </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="7999"> <!-- Ensure price is a number without commas -->
