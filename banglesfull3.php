...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\bangles3.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Royal Blush Bangles</h1>
      
      <div class="price">
        <span class="current-price">₹2,152</span>
      </div>
      
      <p class="product__description">
      Designed for those who seek a regal touch, the Royal Blush Bangles feature luxurious pink and gold detailing. With a pattern inspired by vintage Indian jewelry, these bangles add a majestic flair to any outfit. The use of crystals and beads elevates their opulence, making them perfect for weddings and grand celebrations. Each bangle in this set is carefully crafted to offer both durability and elegance, ensuring they remain timeless pieces in any collection. They’re a statement of grace and sophistication, perfect for anyone who loves traditional jewelry with a modern twist.
      </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="2152"> <!-- Ensure price is a number without commas -->
