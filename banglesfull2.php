...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\bangles2.jpeg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Rose Aura Bangles</h1>
      
      <div class="price">
        <span class="current-price">₹6,393</span>
      </div>
      
      <p class="product__description">
      The Rose Aura Bangles feature a soft pink base adorned with intricate gold patterns and stone embellishments, making them the epitome of grace. Perfect for a bride or anyone looking to add a touch of romance to their ensemble, this set exudes elegance. The bangles are designed to stand out on their own or blend seamlessly with other jewelry pieces. The warm rose tone is complemented by the delicate gold accents, bringing a balanced and refined appeal. These bangles are crafted to embody femininity and style, ideal for both traditional and contemporary looks.
      </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="6393"> <!-- Ensure price is a number without commas -->
