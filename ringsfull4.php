...
<?php include 'header.php'; ?>
  ...
  <div class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\ring4.jpg" alt="Silver Heart's Paradise Ring" width="533" height="533">
      </div>
    </div>
    <div class="product__info-wrapper">
      <h1 class="product__title">Eclipse Twins</h1>
      <div class="price">₹14,846</div>
      <div class="product__description">
        <p>A delicate embrace of two radiant gems, symbolizing unity and cosmic harmony.</p>
      </div>
