...
<?php include 'header.php'; ?>
  ...
  <div class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\menring3.webp" alt="Silver Heart's Paradise Ring" width="533" height="533">
      </div>
    </div>
    <div class="product__info-wrapper">
      <h1 class="product__title">Golden Heart Diamond Ring</h1>
      <div class="price">₹17,999</div>
      <div class="product__description">
        <p>A golden ring with multiple small diamonds, featuring soft, rounded designs.</p>
      </div>
