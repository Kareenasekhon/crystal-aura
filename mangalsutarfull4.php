...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\mangalsutar4.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Lotus Blossom Mangalsutra</h1>
      
      <div class="price">
        <span class="current-price">₹14,846</span>
      </div>
      
      <p class="product__description">
      Inspired by the purity and grace of a lotus, this mangalsutra’s pendant features delicate floral patterns accented with tiny gemstones. The Lotus Blossom Mangalsutra symbolizes purity, growth, and resilience, making it ideal for a woman who finds beauty in life’s journey. The sleek black beaded chain balances the intricate pendant, giving it a graceful yet impactful look. This piece is perfect for daily wear, reminding the wearer of love and unity in marriage.
        </p>
