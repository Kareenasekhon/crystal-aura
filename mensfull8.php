...
<?php include 'header.php'; ?>
  ...
  <div class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\menring1.jpg" alt="Silver Heart's Paradise Ring" width="533" height="533">
      </div>
    </div>
    <div class="product__info-wrapper">
      <h1 class="product__title">Geometric Diamond Ring</h1>
      <div class="price">₹23,750</div>
      <div class="product__description">
        <p>A modern, angular silver ring with a prominent diamond in the center.</p>
      </div>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        <input type="hidden" name="product_name" value="Geometric Diamond Ring">
