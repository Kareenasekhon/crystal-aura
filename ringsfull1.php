...
<?php include 'header.php'; ?>
  ...
  <div class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images/ring11.webp" alt="Silver Heart's Paradise Ring" width="533" height="533">
      </div>
    </div>
    <div class="product__info-wrapper">
      <h1 class="product__title">Silver Heart's Paradise Ring</h1>
      <div class="price">₹19,181</div>
      <div class="product__description">
        <p>A simplistic design with a beautiful zircon heart in the centre, perfect for expressing love.</p>
      </div>
