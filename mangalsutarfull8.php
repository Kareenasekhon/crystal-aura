...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\mangalsutar8.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Enchanted Garden Mangalsutra</h1>
      
      <div class="price">
        <span class="current-price">₹23,750</span>
      </div>
      
      <p class="product__description">
      The Enchanted Garden Mangalsutra is a delicate piece that captures the essence of nature’s beauty. Featuring floral motifs accented with gemstones, this pendant is perfect for those who feel connected to nature. Its intricate detailing is complemented by the simplicity of the black beaded chain, making it a versatile piece for all occasions. Ideal for a modern woman with a traditional heart, this mangalsutra is a beautiful reminder of growth, unity, and the cycle of life.
       </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="23750"> <!-- Ensure price is a number without commas -->
