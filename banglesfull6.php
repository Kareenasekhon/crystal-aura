...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\bangles6.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Regal Splendor Bangles</h1>
      ...
      Inspired by the grandeur of Indian royalty, the Regal Splendor Bangles feature rich red and gold tones that exude elegance and sophistication. These bangles are adorned with tiny beads and stones, giving them a luxurious feel that’s perfect for bridal wear. Each piece in this set is crafted with precision, ensuring a perfect fit and stunning appearance. They are ideal for adding a bold, traditional touch to any outfit, reflecting a blend of cultural heritage and modern style. This set is for the woman who embraces her heritage with grace.
      </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="8999"> <!-- Ensure price is a number without commas -->
