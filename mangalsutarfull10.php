...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\mangalsutar10.webp" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Eternal Blossoms Mangalsutra</h1>
      
      <div class="price">
        <span class="current-price">₹24,500</span>
      </div>
      
      <p class="product__description">
      The Eternal Blossoms Mangalsutra features an elegant array of floral designs crafted in gold and silver tones, symbolizing the blossoming love in marriage. Each petal in the pendant signifies a promise, making it a romantic and thoughtful piece. This mangalsutra is ideal for women who believe in the beauty of promises and cherish delicate designs. The subtle blend of colors adds a modern touch, making it suitable for daily wear as well as special occasions.
      </p>
