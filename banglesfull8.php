...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\bangles8.webp" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Golden Dewdrop Bangles</h1>
      
      <div class="price">
        <span class="current-price">₹3,750</span>
      </div>
      
      <p class="product__description">
      These Golden Dewdrop Bangles feature a sophisticated pattern with tiny gold beads that sparkle like dewdrops in the morning sun. The beige and gold tones create a neutral palette that pairs well with any color, making these bangles incredibly versatile. Ideal for both daily wear and special occasions, these bangles add a subtle elegance to any outfit. Their lightweight design ensures comfort without compromising style, and the intricate detailing reflects the artistry of skilled jewelers. This set is a perfect blend of tradition and modernity.
      </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="3750"> <!-- Ensure price is a number without commas -->
