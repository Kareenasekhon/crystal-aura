...
<?php include 'header.php'; ?>
  ...
  <div class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images/ring3.jpeg" alt="Silver Heart's Paradise Ring" width="533" height="533">
      </div>
    </div>
    <div class="product__info-wrapper">
      <h1 class="product__title">Queen Attitude Blue  Ring</h1>
      <div class="price">₹20,152</div>
      <div class="product__description">
        <p>A Royal design with a beautiful blue crystal in the centre, perfect for expressing Royalness.</p>
      </div>
