...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\mangalsutar2.webp" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Golden Symphony Mangalsutra</h1>
      
      <div class="price">
        <span class="current-price">₹16,393</span>
      </div>
      
      <p class="product__description">
      With a rich and intricate design, the Golden Symphony Mangalsutra embodies the harmony of two souls coming together. The pendant’s design is inspired by traditional Indian jewelry, with gold filigree work that adds depth and character. This piece is perfect for a bride who values culture and heritage, wanting her jewelry to tell a story. The floral motifs add a touch of femininity, making it a cherished piece that can be passed down through generations as a symbol of love and devotion.
     </p>
