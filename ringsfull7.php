...
<?php include 'header.php'; ?>
  ...
  <div class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images/ring7.jpeg" alt="Silver Heart's Paradise Ring" width="533" height="533">
      </div>
    </div>
    <div class="product__info-wrapper">
      <h1 class="product__title">Twisted Love Diamond Ring</h1>
      <div class="price">₹21,250</div>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        <input type="hidden" name="product_name" value="Twisted Love Diamond Ring">
        <input type="hidden" name="product_price" value="21250"> <!-- Ensure price is a number without commas -->
        <input type="hidden" name="product_image" value="images/ring7.jpeg">
