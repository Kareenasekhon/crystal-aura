...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\bangles5.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Vibrant Charm Bangles</h1>
      
      <div class="price">
        <span class="current-price">₹2,575</span>
      </div>
      
      <p class="product__description">
      With bold colors like red, orange, and green, the Vibrant Charm Bangles bring a playful yet stylish appeal to traditional wear. The golden detailing adds a touch of glamour, while the colored stones give them a vibrant, lively look. These bangles are perfect for festivals, adding a splash of color to any outfit and making a statement of joy and celebration. Their sturdy design ensures they last through many festivities, while their light weight makes them comfortable for long hours. They’re perfect for women who love a colorful, ethnic vibe.
      </p>
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="2575"> <!-- Ensure price is a number without commas -->
        <input type="hidden" name="product_image" value="images\bangles5.jpg">
