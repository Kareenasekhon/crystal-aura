...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\menpendnt2.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Cross crystal Pendant</h1>
      ...
      <p class="product__description">
        This golden mangalsutar features pearls and coloured stones, with cylindrical-shaped motifs interspersed among coloured stones.
      </p>
