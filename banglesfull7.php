...
<head>
  ...
  <section class="product">
    <div class="product__media-wrapper">
      <div class="media">
        <img src="images\bangles7.jpg" alt="Golden Oceania Necklace with pearls and colored stones" width="500" height="500">
      </div>
    </div>
    
    <div class="product__info-wrapper">
      <h1 class="product__title">Twilight Elegance Bangles</h1>
      ...
      The Twilight Elegance Bangles offer a timeless look with their muted gold and silver tones. With small, intricate designs and a subtle shine, these bangles are perfect for evening wear. They add a touch of elegance without overpowering the outfit, making them versatile pieces for both modern and traditional attire. Their lightweight design and smooth edges make them comfortable for extended wear, while the understated look ensures they can be worn on any occasion. This set is perfect for someone who values elegance in simplicity.
      ...
      <form method="POST" action="addtocart.php" class="action add-to-cart-form">
        ...
        <input type="hidden" name="product_price" value="1250"> <!-- Ensure price is a number without commas -->
